        ...
        <div className="h-100 d-flex justify-content-center align-items-center">
          <div>
            ...
            <p>
              ...
              <br />
              - Testing of the mobile application on various devices (Android and
              IOS) via (Emulator/Expo) to ensure cross-platform compatibility
              and optimal user experience.
              <br />- Planning for beta version launch in the USA and Canada,
              targeted for either the end of December 2023 or the beginning of
              January 2024.
            </p>
          </div>
